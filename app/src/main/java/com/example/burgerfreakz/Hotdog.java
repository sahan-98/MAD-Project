...
public class Hotdog extends AppCompatActivity {
    ...
    public void OrderNow1(View view){
        ...
        Intent intent = new Intent(Hotdog.this,Customize.class);
        intent.putExtra("pName", pName);
        intent.putExtra("pPrice", pPrice);
        intent.putExtra("imageView13", R.drawable.hotd1);
    ...
    public void OrderNow2(View view){
        ...
        Intent intent1 = new Intent(Hotdog.this,Customize.class);
        intent1.putExtra("pName", pName);
        intent1.putExtra("pPrice", pPrice);
        intent1.putExtra("imageView13", R.drawable.hotd3);
    ...
    public void OrderNow3(View view){
        ...
        intent1.putExtra("pName", pName);
        intent1.putExtra("pPrice", pPrice);
        intent1.putExtra("imageView13", R.drawable.hotd2);
        intent1.putExtra("username",username);
        startActivity(intent1);
